                ...
                <div className="parallax">
                    <div className="para-content-container">
                        <div className="para-sub-container1">
                            <div className="para-tag">Helping Find Solution For Customer Since 1990</div>
                            <div className="para-sub-tag">Placerat nullam cum a magnis ultrices mattis condimentum cubilia lacinia lacus vel aenean.</div>
                        </div>
