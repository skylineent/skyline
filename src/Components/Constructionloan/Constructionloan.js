...
import servicesbg from "../../Assets/moc/construction.png";

export default function Constructionloan({ handleClick }) {
  return (
    <>
        ...
        <div className="personalloan-container">
          <div className="personalloan-sub-container1">
            ...
            <div className="personalloan-content-container">
              <div className="personalloan-tag">Construction Loan</div>
